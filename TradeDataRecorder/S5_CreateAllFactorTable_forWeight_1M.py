...
# SQL_tuple = pd.read_sql_query("SELECT DISTINCT [code] FROM stock_all_1M_all_factors_for_weight", conn)
...
#         continue
    ...
    # print df.T
    df.to_sql('stock_all_1M_all_factors_for_weight', conn, if_exists='append', index=False, chunksize=100000)